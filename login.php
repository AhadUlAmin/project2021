...
<?php
// resetPassword 
$resetPassword = isset($_GET['resetPassword']) ? "?resetPassword=".$_GET['resetPassword'] : NULL;
...
<div class="card"  style="background:black!important;text-align:center;">
 ...
 ?>
  <div class="card-body" style="background:#212529!important;text-align:left;">
		<form action="athenticate.php<?php echo $resetPassword ;?>" method="POST">
		  <div class="mb-1">
